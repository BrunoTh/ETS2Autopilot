...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.e_autopilot.setGeometry(QtCore.QRect(320, 80, 31, 32))
        ...
        self.e_leftIndicator.setGeometry(QtCore.QRect(130, 120, 31, 32))
        ...
        self.e_rightIndicator.setGeometry(QtCore.QRect(130, 160, 31, 32))
        ...
        self.e_steering.setGeometry(QtCore.QRect(320, 120, 31, 32))
        self.e_steering.setObjectName("e_steering")
        self.e_throttle = QtWidgets.QLineEdit(self.gb_joystick)
        self.e_throttle.setGeometry(QtCore.QRect(320, 160, 31, 32))
        ...
        self.e_vjoy.setGeometry(QtCore.QRect(130, 80, 31, 32))
        self.e_vjoy.setObjectName("e_vjoy")
        self.b_setAutopilot = QtWidgets.QPushButton(self.gb_joystick)
        self.b_setAutopilot.setGeometry(QtCore.QRect(360, 80, 31, 31))
        self.b_setAutopilot.setObjectName("b_setAutopilot")
        self.b_setLeftIndicator = QtWidgets.QPushButton(self.gb_joystick)
        self.b_setLeftIndicator.setGeometry(QtCore.QRect(170, 120, 31, 31))
        self.b_setLeftIndicator.setObjectName("b_setLeftIndicator")
        self.b_setRightIndicator = QtWidgets.QPushButton(self.gb_joystick)
        self.b_setRightIndicator.setGeometry(QtCore.QRect(170, 160, 31, 31))
        self.b_setRightIndicator.setObjectName("b_setRightIndicator")
        self.b_setSteering = QtWidgets.QPushButton(self.gb_joystick)
        self.b_setSteering.setGeometry(QtCore.QRect(360, 120, 31, 31))
        self.b_setSteering.setObjectName("b_setSteering")
        self.b_setThrottle = QtWidgets.QPushButton(self.gb_joystick)
        self.b_setThrottle.setGeometry(QtCore.QRect(360, 160, 31, 31))
        self.b_setThrottle.setObjectName("b_setThrottle")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.b_setAutopilot.setText(_translate("MainWindow", "Set"))
        self.b_setLeftIndicator.setText(_translate("MainWindow", "Set"))
        self.b_setRightIndicator.setText(_translate("MainWindow", "Set"))
        self.b_setSteering.setText(_translate("MainWindow", "Set"))
        self.b_setThrottle.setText(_translate("MainWindow", "Set"))
